...
class Student(models.Model):                                            # Modelo de alumnos que juegan
    ...
    name = models.CharField(max_length=100)                             # Nombre, opcional
...
class Log(models.Model):
    actionPerformed = models.CharField(max_length=255, null=False, blank=False)     # Accion realizada por el usuario, CRUD
    student = models.CharField(max_length=255, null=False, blank=False)